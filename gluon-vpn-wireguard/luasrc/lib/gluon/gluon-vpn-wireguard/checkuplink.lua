...
function start_gateway(prefix)
	...
	os.execute("ebtables-tiny -I FORWARD 1 -i bat0 --logical-in br-client -p IPv6 --ip6-proto ipv6-icmp --ip6-icmp-type router-advertisement -j DROP")
	...
	radvd_arguments_fd:write("--rdnss " .. prefix_net .. "1")
